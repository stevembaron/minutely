...
function IOSStatusBar({ dark = false }) {
  ...
  return (
    <div style={{
      ...
      <span style={{ fontFamily: '-apple-system, SF Pro, system-ui', fontWeight: 590, fontSize: 15, color: c }}>{time}</span>
...
export function IOSDevice({ children, dark = false }: IOSDeviceProps) {
  return (
    <div style={{
